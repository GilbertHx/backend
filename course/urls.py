...
urlpatterns = [
    ...
    url(r'^unit/(?P<pk>[0-9a-f-]+)/edit/$', views.UnitUpdateAPIView.as_view(), name='update_unit'),
    ...
    url(r'^unit/assessment/completion/$', views.UnitAssessmentCompletedListAPIView.as_view(), name='list_unit_assessment_completed'),
    url(r'^complete/unit/create/$', views.UnitAssessmentCompletedCreateAPIView.as_view(), name='create_complete_unit'),
    ...
    url(r'^session/(?P<pk>[0-9a-f-]+)/edit/$', views.SessionUpdateAPIView.as_view(), name='edit_session'),
    ...
    url(r'^lesson/(?P<pk>[0-9a-f-]+)/edit/$', views.LessonUpdateAPIView.as_view(), name='edit_lesson'),
